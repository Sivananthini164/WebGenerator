  ...
  return (
    <>
      <div className='h-screen w-full bg-zinc-300 flex flex-col items-center justify-center'>
        <div className='p-10 w-4/5  m-2 text-5xl font-bold text-center text-red-800'>
          Create Beautiful Websites in Minutes - No Code, Just AI 
        </div>
        <div className='p-8 w-4/5  m-2 text-3xl font-semibold text-center text-red-800'>
          Build modern, responsive websites in minutes with intelligent automation. No coding skills required
        </div>
        <button
          onClick={() => setShowModal(true)}
          className='p-4  bg-blue-950 text-red-600 rounded-[18px] m-4 text-2xl font-semibold'>
